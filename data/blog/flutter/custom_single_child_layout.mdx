...
draft: false
tags: ['Flutter']
images: ['https://flutter.cn/assets/images/docs/catalog-widget-placeholder.png']
summary: 'CustomSingleChildLayout 可以使其唯一的子节点的布局遵循一个委托。 委托可以确定子组件的布局约束，并决定将子组件放置在何处。委托还可以确定父级的大小，但父类的大小不会取决于子类的大小。'
---

> 本文并没有达到我认为可以公开的标准，虽然我暂无打算去修改它，但它现在的作用是提供一个展现嵌入 Dartpad 的例子。
...
<iframe
  width="100%"
  height="500px"
  src="https://dartpad.dev/embed-flutter.html?id=9239524e218ede1100f436e8de59e957&run=true&theme=dark"
></iframe>
